...
# Load Dataframe
data = load_standard_data_frame(get_all_historical_data('BCH'))
...
model.save(f'../saved_model/BCH_model_for_days_from_full_data__val_lose_{val_loss[-1]}')
dump(sc, f'../saved_model/BCH_scaler_for_model_for_full_data_days_val_lose_{val_loss[-1]}')

save_info(ONE_BATCH_SIZE,BATCH_SIZE,EPOCHS,TRAIN_TEST_SPLIT_POINT,loss,val_loss,model,'BCH','full_data_days')
